...
<div id="sims_header">	<!--1-->
	...
	<div style="height:100px;">  <!--2-->
		...
		<div style="height:0px;background-color:red;float:">
			<center>
			  <a href="StudentRegController"><button onclick="" class="cool-button"><h4>STUDENT REGISTRATION</h4></button></a></br>&nbsp;&nbsp;&nbsp;
			  <br><a href="ShowStuRegController"><button onclick="" class="cool-button"><h4>SHOW ALL DETAILS</h4></button></a>&nbsp;
			 </center>
		</div>
		</div> 
		<!--end container-->
