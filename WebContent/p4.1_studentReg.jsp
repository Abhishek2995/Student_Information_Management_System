...
<!---------------------------------end header  top logout----------------------------------------->
		...
		<center>
			<h2 style="color:#40e0d0; font-family:Comic Sans MS;"><u>STUDENT REGISTRATION</u></h2>
		</center>
	...
	<div>
	<center>
		<form action="StudentRegController" method="post">
		<label for="fname">First Name</label>&emsp;&emsp;&emsp;
		<input type="text" id="fname" name="firstname" placeholder="Your name.."></br>
		
		<label for="mname">Middle Name</label>&emsp;&emsp;
		<input type="text" id="mname" name="middlename" placeholder="Your middle name.."></br>
